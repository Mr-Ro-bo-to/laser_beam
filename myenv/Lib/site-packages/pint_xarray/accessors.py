...
class DatasetLocIndexer:
    ...
    def __getitem__(self, indexers):
        ...
        try:
            converted = conversion.rescale_by_units(self.ds, indexer_units)
...
class DataArrayLocIndexer:
    ...
    def __getitem__(self, indexers):
        ...
        # convert the indexes to the indexer's units
        try:
            converted = conversion.rescale_by_units(self.da, indexer_units)
        except ValueError as e:
            raise KeyError(*e.args) from e
...
class PintDataArrayAccessor:
    ...
    def to(self, units=None, **unit_kwargs):
        ...
        **unit_kwargs
        ...
        return conversion.rescale_by_units(self.da, units)
...
class PintDatasetAccessor:
    ...
    def to(self, units=None, **unit_kwargs):
        ...
        **unit_kwargs
        ...
        return conversion.rescale_by_units(self.ds, units)
