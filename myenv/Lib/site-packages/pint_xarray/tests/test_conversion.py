...
class TestArrayFunctions:
    ...
    def test_array_rescale_by_units(self, data, unit, expected, error, match):
        if error is not None:
            with pytest.raises(error, match=match):
                conversion.array_rescale_by_units(data, unit)

            return

        actual = conversion.array_rescale_by_units(data, unit)
        assert_array_equal(expected, actual)
...
class TestXarrayFunctions:
    ...
    def test_rescale_by_units(self, type, variant, units, error, suberrors):
        variants = {
        ...
        if error is not None:
            ...
            with pytest.RaisesGroup(
                *matchers,
                ...
                conversion.rescale_by_units(obj, units)
        ...
        actual = conversion.rescale_by_units(obj, units)
